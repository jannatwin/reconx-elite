...
def generate_pdf_report(
    ...
    report_text = f"ReconX Elite Report for {target.domain} generated at {datetime.now(timezone.utc).isoformat()}"
    pdf_content = (
        "%PDF-1.4\n"
        "1 0 obj<</Type/Catalog/Pages 2 0 R>>endobj\n"
        "2 0 obj<</Type/Pages/Count 1/Kids[3 0 R]>>endobj\n"
        "3 0 obj<</Type/Page/Parent 2 0 R/MediaBox[0 0 612 792]/Contents 4 0 R>>endobj\n"
        f"4 0 obj<</Length {len(report_text) + 40}>>stream\nBT /F1 12 Tf 72 720 Td ({report_text}) Tj ET\nendstream endobj\n"
        "xref\n0 5\n0000000000 65535 f \n"
