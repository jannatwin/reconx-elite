    ...
    async def _validate_models(self) -> Dict[str, Any]:
        ...
        try:
            ...
            from app.models import (
                User, Target, Scan, Vulnerability, ExploitValidation,
                OutOfBandInteraction, LearningPattern, SuccessfulPayload,
                HighValueEndpoint, CustomNucleiTemplate, AIReport
            )
    ...
    async def _validate_services(self) -> Dict[str, Any]:
        ...
        try:
            ...
            from app.services import (
                ai_service, exploit_validator, out_of_band_service,
                manual_tester, intelligence_learning, custom_template_engine,
                logging_service
            )
