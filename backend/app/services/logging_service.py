...
class ReconXLogger:
    ...
    def log_security_event(self, event: str, details: Dict[str, Any], user_id: Optional[int] = None, severity: str = "medium"):
    ...
    def log_scan_event(self, event: str, scan_id: int, details: Dict[str, Any], user_id: Optional[int] = None):
    ...
    def log_validation_event(self, event: str, details: Dict[str, Any], user_id: Optional[int] = None):
        ...
        self.log_structured(
            ...
            data={
                "details": details,
                "source": "exploit_validator"
            },
            user_id=user_id
        )
    
    def log_oob_event(self, event: str, callback_id: str, details: Dict[str, Any], user_id: Optional[int] = None):
