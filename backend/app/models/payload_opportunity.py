...
class PayloadOpportunity(Base):
    ...
    parameter_location = Column(String(32), nullable=False, default="query")  # query, body, path, header
    vulnerability_type = Column(String(50), nullable=False, index=True)  # xss, sqli, ssti, ssrf, openredirect
    ...
    tested_json = Column(JSON, default=dict)  # {payload: {status: int, reflected: bool, response_snippet: str}}
