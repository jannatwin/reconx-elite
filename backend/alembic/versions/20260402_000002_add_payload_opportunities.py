...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("parameter_location", sa.String(length=32), nullable=False, server_default="query"),
    ...
    op.create_index("ix_payload_opportunities_vulnerability_type", "payload_opportunities", ["vulnerability_type"])


def downgrade() -> None:
    op.drop_index("ix_payload_opportunities_vulnerability_type", table_name="payload_opportunities")
